...
public interface DefaultMap<K, V> extends Map<K, V> {
     ...
     *           value is obtained with its {@code getValue} operation, the entry is
     *           removed from the collection (and the backing map) with the
     *           iterator's {@code remove} operation, and the saved value is
     ...
     *           <p>
     * 	  Note that this implementation throws an
     *           {@code UnsupportedOperationException} if the {@code entrySet} does
     ...
     *           "wrapper object" over this map's {@code entrySet()} iterator. The
     *           {@code size} method delegates to this map's {@code size} method and
     *           the {@code contains} method delegates to this map's
	...
	return new AbstractSet<K>() {
	    ...
	    public int size() {
		return DefaultMap.this.size();
	    }

	    public boolean isEmpty() {
		return DefaultMap.this.isEmpty();
	    }

	    public void clear() {
		DefaultMap.this.clear();
	    }

	    public boolean contains(Object k) {
		return DefaultMap.this.containsKey(k);
	    }
	};
    }
    ...
    public default Collection<V> values() {
        return new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return DefaultMap.this.containsValue(v);
                }
            };
    }
	 ...
	 * character ("{@code =}") followed by the string representation of this entry's
	 * value.
	 *
